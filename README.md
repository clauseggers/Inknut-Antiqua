...
Inknut Antiqua is designed by **[Claus Eggers Sørensen](http://forthehearts.net/)** in 2014, and is published under the **![SIL Open Font License Version 1.1](https://github.com/clauseggers/Inknut-Antiqua/OFL.txt)**.

You will find the UFOs of the masters in the  **![UFOs](https://github.com/clauseggers/Inknut-Antiqua/UFOs)** folder, and a web-specimen with CFF-OTF fonts in the folder **![Fonts & Specimen](https://github.com/clauseggers/Inknut-Antiqua/Fonts%20%26%20Specimen/Inknut%20Antiqua%20SPECIMEN%20FINAL.html)**. Please use Firefox to view this specimen, as only Firefox support localised text.
